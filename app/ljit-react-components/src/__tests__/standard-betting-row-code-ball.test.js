...
import CodeBall from '../components/standard-betting-row/code-ball';

describe('CodeBall', () => {
	it('should be selectable by class ljit-betting-block', () => {
		const wrapper = shallow(<CodeBall/>);

		expect(wrapper.hasClass('ljit-betting-block')).toEqual(true);
	});
	...
	describe('handle click ball', () => {
		...
		beforeEach(() => {
			...
			component = <CodeBall codes={codes} onPressCodeBall={callback}/>;
		});
		afterEach(() => {
			codes = undefined;
			callback = undefined;
		...
		it('should handle click ball 0', () => {
			...
			wrapper.find('.ljit-bet-ball__ball').at(0).simulate('click');
		...
		it('should handle click ball 1', () => {
			...
			wrapper.find('.ljit-bet-ball__ball').at(1).simulate('click');
			expect(callback).toHaveBeenCalled();
		...
		it('should handle click ball 2', () => {
			...
			wrapper.find('.ljit-bet-ball__ball').at(2).simulate('click');
			expect(callback).toHaveBeenCalled();
		...
		it('should handle click ball 3', () => {
			...
			wrapper.find('.ljit-bet-ball__ball').at(3).simulate('click');
			expect(callback).toHaveBeenCalled();
		...
		it('should handle click ball 4', () => {
			...
			wrapper.find('.ljit-bet-ball__ball').at(4).simulate('click');
			expect(callback).toHaveBeenCalled();
		...
		it('should handle click ball 5', () => {
			...
			wrapper.find('.ljit-bet-ball__ball').at(5).simulate('click');
			expect(callback).toHaveBeenCalled();
		...
		it('should handle click ball 6', () => {
			...
			wrapper.find('.ljit-bet-ball__ball').at(6).simulate('click');
			expect(callback).toHaveBeenCalled();
		...
		it('should handle click ball 7', () => {
			...
			wrapper.find('.ljit-bet-ball__ball').at(7).simulate('click');
			expect(callback).toHaveBeenCalled();
		...
		it('should handle click ball 8', () => {
			...
			wrapper.find('.ljit-bet-ball__ball').at(8).simulate('click');
			expect(callback).toHaveBeenCalled();
		...
		it('should handle click ball 9', () => {
			...
			wrapper.find('.ljit-bet-ball__ball').at(9).simulate('click');
			expect(callback).toHaveBeenCalled();
	...
	describe('handle click option', () => {
		...
		beforeEach(() => {
			...
			callback = jest.fn();
			title = '万位';
			component = <CodeBall title={title} quickOptions={quickOptions} onPressQuickOption={callback} />;
		});
		afterEach(() => {
		...
		it('should handle click 大', () => {
			...
			wrapper.find('.ljit-betting-block__select-block-options').at(0).simulate('click');
			expect(callback).toHaveBeenCalled();
		...
		it('should handle click 小', () => {
			...
			wrapper.find('.ljit-betting-block__select-block-options').at(1).simulate('click');
			expect(callback).toHaveBeenCalled();
		...
		it('should handle click 單', () => {
			...
			wrapper.find('.ljit-betting-block__select-block-options').at(2).simulate('click');
			expect(callback).toHaveBeenCalled();
		...
		it('should handle click 雙', () => {
			...
			wrapper.find('.ljit-betting-block__select-block-options').at(3).simulate('click');
			expect(callback).toHaveBeenCalled();
		...
		it('should handle click 全', () => {
			...
			wrapper.find('.ljit-betting-block__select-block-options').at(4).simulate('click');
			expect(callback).toHaveBeenCalled();
		...
		it('should handle click 清', () => {
			...
			wrapper.find('.ljit-betting-block__select-block-options').at(5).simulate('click');
			expect(callback).toHaveBeenCalled();
