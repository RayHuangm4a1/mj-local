...
class RebateEditInputTable extends Component {
	constructor() {
		super();
					...
					render: (highest, record) => (
						<LabelContent>
							<InputNumber
								...
								onChange={(event) => _handleChangeCellValue(event, record, 'highestRebate')}
							/>
						</LabelContent>
					),
				}]}
...
RebateEditInputTable.propTypes = propTypes;
RebateEditInputTable.defaultProps = defaultProps;

export default RebateEditInputTable;
