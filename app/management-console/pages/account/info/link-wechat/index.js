...
class AccountInfoLinkWechatPage extends Component {
	constructor() {
		super();
		this.state = {
		...
		this._handleDeleteLink = this._handleDeleteLink.bind(this);
	...
	_renderTable() {
		...
		return (
			<Table
				...
				columns={columns}
				dataSource={data}
				onTableChange={this._handleChangeTable}
			/>
		);
	}
	...
	render() {
		...
		return (
			<PageBlock
				className="account-member-link-wechat"
				noMinHeight
			>
				<Message
					...
					onClickCancel={this._hideModal}
					onClickOk={this._handleDeleteLink}
				>
				</Message>
				<SearchForm
...
AccountInfoLinkWechatPage.propTypes = propTypes;
AccountInfoLinkWechatPage.defaultProps = defaultProps;

export default AccountInfoLinkWechatPage;
