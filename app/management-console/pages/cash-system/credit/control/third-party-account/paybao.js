...
class CashSystemCreditControlThirdPartyAccountPaybaoPage extends Component {
	constructor() {
		super();
		this.state = {
			formTitle: '',
					...
					<HeaderButtonBar
						right={(
							<Button
								...
								onClick={() => this._handleShowForm('支付宝帐户新增')}
							>
								新增支付宝帐户
							</Button>
						)}
							...
							},
							{
								...
								render: (text, record) => (
									<Fragment>
										...
										<ModifyTextButton
											onClick={() => this._handleEditForm('支付宝帐户修改', record)}
										/>
									</Fragment>
								),
							},
...
CashSystemCreditControlThirdPartyAccountPaybaoPage.propTypes = propTypes;

export default CashSystemCreditControlThirdPartyAccountPaybaoPage;
