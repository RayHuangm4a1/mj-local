...
class CashSystemCreditControlThirdPartyAccountWechatPage extends Component {
	constructor() {
		super();
		this.state = {
			formTitle: '',
					...
					<HeaderButtonBar
						right={(
							<Button
								...
								onClick={() => this._handleShowForm('微信帐户新增')}
							>
								新增微信帐户
							</Button>
						)}
							...
							},
							{
								...
								render: (text, record) => (
									<Fragment>
										...
										<ModifyTextButton
											onClick={() => this._handleEditForm('微信帐户修改', record)}
										/>
									</Fragment>
								),
							},
...
CashSystemCreditControlThirdPartyAccountWechatPage.propTypes = propTypes;

export default CashSystemCreditControlThirdPartyAccountWechatPage;
