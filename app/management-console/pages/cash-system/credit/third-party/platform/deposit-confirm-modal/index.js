...
import { DEPOSIT_MODAL_PREFIX_CLASS, } from '../../../utils';
...
class DepositConfirmModal extends Component {
	...
	render() {
		...
		return (
			...
			>
				<Row>
					<div className="title">第三方交易纪录</div>
					<Col span={12}>
						<div className="attr">
							<div className="attr-label"><span>交易时间</span></div>
							<div className="attr-value"><span>{formatedTransactedAt}</span></div>
						</div>
						<div className="attr">
							<div className="attr-label"><span>存入第三方</span></div>
							<div className="attr-value"><span>{depositedThirdParty}</span></div>
						</div>
						<div className="attr">
							<div className="attr-label"><span>备注</span></div>
					...
					<Col span={12}>
						...
						<div className="attr">
							<div className="attr-label"><span>收款卡号</span></div>
							<div className="attr-value">{debitCardNumber}</div>
						</div>
					</Col>
				</Row>
				<Divider />
