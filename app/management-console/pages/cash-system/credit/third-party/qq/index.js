...
class CashSystemCreditThirdPartyQQPage extends Component {
	constructor(props) {
		super(props);
		this.state = {
			source: Deposit,
...
CashSystemCreditThirdPartyQQPage.propTypes = propTypes;
CashSystemCreditThirdPartyQQPage.defaultProps = defaultProps;

export default CashSystemCreditThirdPartyQQPage;
