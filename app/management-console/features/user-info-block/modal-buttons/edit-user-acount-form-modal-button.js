...
function EditUserAccountFormModalButton({
	buttonText,
	isDisabled,
	formTitle,
	onSubmitForm,
	...
	const prevUserAccountUpdateLoadingStatus = usePrevious(userAccountUpdateLoadingStatus);
	...
	useEffect(() => {
		if (isModalEdited
			&& userAccountUpdateLoadingStatus === SUCCESS
			&& prevUserAccountUpdateLoadingStatus === LOADING) {
...
EditUserAccountFormModalButton.propTypes = propTypes;
EditUserAccountFormModalButton.defaultProps = defaultProps;

export default connect(mapStateToProps, mapDispatchToProps)(EditUserAccountFormModalButton);
